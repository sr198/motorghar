        ...
        >
          <View style={styles.section}>
            ...
            <Text
              ...
              role="heading"
            >
              Welcome MotorgharMobileMygarage 👋
            </Text>
          </View>
          <View style={styles.section}>
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx build MotorgharMobileMygarage
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Test
                </Text>
                ...
                >
                  nx test MotorgharMobileMygarage
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint MotorgharMobileMygarage
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p MotorgharMobileMygarage -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project MotorgharMobileMygarage
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
